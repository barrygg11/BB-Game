...
Route::get('/bingo', [GameController::class,'bingoIndex'])->name('bingo'); //吉祥賓果介面
Route::post('/bingo', [GameController::class,'bingo']); // 吉祥賓果
...
Route::get('/userSearchControl', [AdminGameControlController::class, 'userSearchControlIndex'])->name('userSearchControl'); //會員帳務管理介面
Route::post('/userSearchControl', [AdminGameControlController::class, 'userSearchControl']); //會員帳務管理
